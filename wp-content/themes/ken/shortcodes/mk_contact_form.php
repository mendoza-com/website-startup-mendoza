...
$name_str = __( 'NOMBRE COMPLETO', 'mk_framework' );
$email_str = __( 'EMAIL', 'mk_framework' );
$submit_str = __( 'ENVIAR CONSULTA', 'mk_framework' );
$content_str = __( 'TU CONSULTA U OPINIÓN', 'mk_framework' );
$phone_str = __( 'TELÉFONO', 'mk_framework' );
$enter_captcha = __( 'Ingresar Captcha', 'mk_framework' );
$not_readable = __( 'Ilegible?', 'mk_framework' );
$change_text= __( 'Cambiar texto.', 'mk_framework' );
