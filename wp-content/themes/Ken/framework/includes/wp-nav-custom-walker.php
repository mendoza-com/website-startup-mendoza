...
class mk_artbees_custom_menu {
    ...
    function __construct() {
        ...
        add_filter( 'wp_setup_nav_menu_item', array( $this, 'mk_artbees_add_custom_nav_fields' ) );

        // save menu custom fields
        add_action( 'wp_update_nav_menu_item', array( $this, 'mk_artbees_update_custom_nav_fields'), 10, 3 );
        
        // edit menu walker
        add_filter( 'wp_edit_nav_menu_walker', array( $this, 'mk_artbees_edit_walker'), 10, 2 );
...
$GLOBALS['artbees_custom_menu'] = new mk_artbees_custom_menu();
 ...
 * @return      void
*/
class mk_custom_walker extends Walker_Nav_Menu {
    /**
         * @var int $columns 
         */
        var $columns = 0;
