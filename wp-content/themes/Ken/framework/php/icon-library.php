...
function icon_library_submenu_page_callback() {
	...
	foreach ($mk_icons_list as $key => $value) {
		...
		echo '<li class="medium"><i class="mk-' . $key . '" ></i></li>';
		echo '<li class="class-name" title="Class name"><span title="Copy and paste this into icon font shortcode">Class Name:</span>mk-' . $key . '</li>';
