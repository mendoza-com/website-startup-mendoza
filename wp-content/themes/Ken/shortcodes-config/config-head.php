...
$posts = $categories = $pages =  $testimonials = $clients = $portfolio_posts = $edge_posts = $tab_posts = $employees = $pricing = $animated_columns = $infinite_animation =  $mk_awesome_icons_list = $mk_orderby = $device_visibility = $css_animations = array();
