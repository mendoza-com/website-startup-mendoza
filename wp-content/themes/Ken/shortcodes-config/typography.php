...
vc_map(array(
    ...
    "category" => __('Typography', 'mk_framework'),
    'description' => __( 'Advanced headings with cool styles.', 'js_composer' ),
    "params" => array(
...
vc_map(array(
    ...
    'description' => __( 'Adds title text into a highlight box.', 'js_composer' ),
    "params" => array(
...
vc_map(array(
    ...
    'description' => __( 'Blockquote modules', 'js_composer' ),
    "params" => array(
...
vc_map(array(
    ...
    "category" => __('Typography', 'mk_framework'),
    'description' => __( 'Dropcaps element shortcode.', 'js_composer' ),
    "params" => array(
...
vc_map(array(
    ...
    "category" => __('Typography', 'mk_framework'),
    'description' => __( 'adds highlight to an inline text.', 'js_composer' ),
    "params" => array(
...
vc_map(array(
    ...
    'description' => __( 'Powerful list styles with icons.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "textarea_html",
            "holder" => "div",
...
vc_map(array(
    ...
    "category" => __('Typography', 'mk_framework'),
    'description' => __( 'Advanced font icon element', 'js_composer' ),
    "params" => array(
...
vc_map(array(
    ...
    "category" => __('Typography', 'mk_framework'),
    'description' => __( 'Expandable toggle element', 'js_composer' ),
    "params" => array(
...
vc_map(array(
    ...
    "params" => array(
        array(
            ...
            "description" => __("Choose your tabs style.", "js_composer")
        ),
        array(
            "type" => "dropdown",
            ...
            "description" => __("Choose tabs orientation. Please note that this option will only work for style 1 and 2.", "js_composer")
        ),
        array(
            "type" => "colorpicker",
