...
vc_map( array(
    ...
    'params' => array(
        array(
            "type" => "colorpicker",
            "heading" => __("Column Background Color (Deprecated, Use design options tab)", "mk_framework"),
            "param_name" => "bg_color",
            "value" => "",
            "description" => __("You can optionally add Background color to columns.", "mk_framework")
        ),
        array(
            "type" => "colorpicker",
            ...
            "value" => "",
            "description" => __("You can optionally add border color to columns. Please note that the border color option under design options pane will not work and you should use this option instead (For Legacy users we had to keep this option)", "mk_framework")
        ),
        array(
            'type' => 'colorpicker',
