...
echo '<a href="http://artbees.net/themes/ken-demo/" target="_blank" class="button">' . __('Preview', 'mk_framework') . '</a>';
echo '</div>';
...
foreach (glob($dir) as $folder) {
    if (basename($folder) != 'main') {
        ...
        echo '<div class="button-holder">';
        echo '<input id="import" type="submit" value="' . __('Install', 'mk_framework') . '" class="button-primary mk-import-content-btn" />';
        echo '<a href="http://artbees.net/themes/ken-demo/' . basename($folder) . '" target="_blank" class="button">' . __('Preview', 'mk_framework') . '</a>';
        echo '</div>';
