...
class CozyEdgeIonIcons implements iCozyEdgeIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = EDGE_ASSETS_ROOT . "/css/ion-icons/css/ionicons.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="edgtf-icon-ion-icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
