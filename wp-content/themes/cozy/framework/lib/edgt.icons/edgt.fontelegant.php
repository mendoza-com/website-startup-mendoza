...
class CozyEdgeIconsFontElegant implements iCozyEdgeIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = EDGE_ASSETS_ROOT . "/css/elegant-icons/style.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<span aria-hidden="true" class="edgtf-icon-font-elegant ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></span>';
