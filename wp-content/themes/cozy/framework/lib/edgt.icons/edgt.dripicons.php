...
/**
 * Class CozyEdgeDripicons
 */
class CozyEdgeDripicons implements iCozyEdgeIconCollection {
    /**
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = EDGE_ASSETS_ROOT . "/css/dripicons/dripicons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="edgtf-icon-dripicons dripicon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
