...
class CozyEdgeIconsFontAwesome implements iCozyEdgeIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = EDGE_ASSETS_ROOT . "/css/font-awesome/css/font-awesome.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="edgtf-icon-font-awesome fa ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
