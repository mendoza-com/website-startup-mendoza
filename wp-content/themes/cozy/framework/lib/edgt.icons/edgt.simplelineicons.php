...
class CozyEdgeSimpleLineIcons implements iCozyEdgeIconCollection {
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = EDGE_ASSETS_ROOT . "/css/simple-line-icons/simple-line-icons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="edgtf-icon-simple-line-icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString .
            '></i>';
