...
class CozyEdgeLineaIcons implements iCozyEdgeIconCollection {
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = EDGE_ASSETS_ROOT . "/css/linea-icons/style.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="edgtf-icon-linea-icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
