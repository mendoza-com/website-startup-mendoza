(function() {
	tinymce.PluginManager.add('edgt_shortcodes', function( ed, url ) {
		ed.addButton( 'edgt_shortcodes', {
			...
			menu: [
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[edgtf_blockquote text="' + e.data.text + '" title_tag="' + e.data.title_tag + '" width="' + e.data.width + '"]');
							}
						});
					}
				},
				...
				},
				{
					text: 'Ordered List',
					onclick: function() {
						ed.insertContent('[edgtf_list_ordered]<ol><li>Lorem Ipsum</li><li>Lorem Ipsum</li><li>Lorem Ipsum</li></ol>[/edgtf_list_ordered');
					}
				},
				{
					text: 'Unordered List',
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent('[edgtf_unordered_list style="' + e.data.style + '" animate="' + e.data.animate + '" font_weight="' + e.data.font_weight + '"]<ul><li>Lorem ipsum</li><li>Lorem ipsum</li><li>Lorem ipsum</li></ul>[/edgtf_unordered_list]');
							}
						});
					}
				},
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								...
								ed.insertContent('[edgtf_icon_list_item icon_pack="' + e.data.icon_pack + '" ' + icon_pack_prefix + '="' + e.data.icon + '" icon_size="' + e.data.icon_size + '" icon_color="' + e.data.icon_color + '" title="' + e.data.title + '" title_color="' + e.data.title_color + '" title_size="' + e.data.title_size + '"]');
							}
						});
					}
				},
