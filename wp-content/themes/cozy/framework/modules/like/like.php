...
class CozyEdgeLike {
	...
	private function __construct() {
		...
		add_action('wp_ajax_cozy_edge_like', array( $this, 'ajax'));
		add_action('wp_ajax_nopriv_cozy_edge_like', array( $this, 'ajax'));
	}
	...
	public function add_like() {
		...
		$title = esc_html__('Like this', 'cozy');
		if( isset($_COOKIE['edgtf-like_'. $post->ID]) ){
			$class = 'edgtf-like liked';
			$title = esc_html__('You already like this!', 'cozy');
		}
...
global $cozy_edge_like;
$cozy_edge_like = CozyEdgeLike::get_instance();
