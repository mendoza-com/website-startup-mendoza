...
if(!function_exists('cozy_edge_title_classes')) {
    /**
     * Function that adds classes to title div.
     * All other functions are tied to it with add_filter function
     * @param array $classes array of classes
     */
    function cozy_edge_title_classes($classes = array()) {
        $classes = array();
        $classes = apply_filters('cozy_edge_title_classes', $classes);
...
if(!function_exists('cozy_edge_title_type_class')) {
    /**
     ...
     */
    function cozy_edge_title_type_class($classes) {
    ...
    add_filter('cozy_edge_title_classes', 'cozy_edge_title_type_class');
}

if(!function_exists('cozy_edge_title_background_image_classes')) {
    function cozy_edge_title_background_image_classes($classes) {
        //init variables
        $id                         = cozy_edge_get_page_id();
        $is_img_responsive 		    = '';
        $is_image_parallax		    = '';
        ...
        if(($meta_temp = get_post_meta($id, "edgtf_title_area_background_image_meta", true)) != ""){
            ...
            $title_img = cozy_edge_options()->getOptionValue('title_area_background_image');
        }
        ...
        if(($meta_temp = get_post_meta($id, "edgtf_title_area_background_image_parallax_meta", true)) != ""){
            ...
            $is_image_parallax = cozy_edge_options()->getOptionValue('title_area_background_image_parallax');
        }
    ...
    add_filter('cozy_edge_title_classes', 'cozy_edge_title_background_image_classes');
}

if(!function_exists('cozy_edge_title_content_alignment_class')) {
    /**
     ...
     * @return array changed array of classes
     */
    function cozy_edge_title_content_alignment_class($classes) {
        ...
        if(($meta_temp = get_post_meta($id, "edgtf_title_area_content_alignment_meta", true)) != "") {
            ...
            $title_content_alignment = cozy_edge_options()->getOptionValue('title_area_content_alignment');
        }
    ...
    add_filter('cozy_edge_title_classes', 'cozy_edge_title_content_alignment_class');
}


if(!function_exists('cozy_edge_title_text_size_class')) {
	/**
	 ...
	 * @return array changed array of classes
	 */
	function cozy_edge_title_text_size_class($classes) {

		//init variables
        $id = cozy_edge_get_page_id();

		$title_size = cozy_edge_get_meta_field_intersect('title_area_text_size', $id);
	...
	add_filter('cozy_edge_title_classes', 'cozy_edge_title_text_size_class');
}


if(!function_exists('cozy_edge_title_animation_class')) {
    /**
     * Function that adds class on title based on title animation option
     * @param $classes original array of classes
     * @return array changed array of classes
     */
    function cozy_edge_title_animation_class($classes) {
        ...
        if(($meta_temp = get_post_meta($id, "edgtf_title_area_animation_meta", true)) !== "") {
            ...
            $title_animation = cozy_edge_options()->getOptionValue('title_area_animation');
        }
    ...
    add_filter('cozy_edge_title_classes', 'cozy_edge_title_animation_class');
}

if(!function_exists('cozy_edge_title_background_image_div_classes')) {
    function cozy_edge_title_background_image_div_classes($classes) {
    ...
    add_filter('cozy_edge_title_classes', 'cozy_edge_title_background_image_div_classes');
}

if(!function_exists('cozy_edge_title_border_class')) {
	/**
	 ...
	 * @return array changed array of classes
	 */
	function cozy_edge_title_border_class($classes) {

		$title_border = cozy_edge_get_meta_field_intersect('title_area_border_bottom');
	...
	add_filter('cozy_edge_title_classes', 'cozy_edge_title_border_class');
}