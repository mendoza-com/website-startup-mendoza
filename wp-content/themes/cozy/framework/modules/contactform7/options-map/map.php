...
if ( ! function_exists('cozy_edge_contact_form_7_options_map') ) {

	function cozy_edge_contact_form_7_options_map() {

		cozy_edge_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7','cozy'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = cozy_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'cozy')
		));

		//Text Typography

		$typography_text_group = cozy_edge_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography','cozy'),
			'description'	=> esc_html__('Setup typography for form elements text','cozy'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = cozy_edge_add_admin_row(array(
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color','cozy'),
		));
		...
		$typography_text_row2 = cozy_edge_add_admin_row(array(
		...
		$typography_text_row3 = cozy_edge_add_admin_row(array(
		...
		$typography_label_group = cozy_edge_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography','cozy'),
			'description'	=> esc_html__('Setup typography for form elements label','cozy'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = cozy_edge_add_admin_row(array(
		...
		$typography_label_row2 = cozy_edge_add_admin_row(array(
		...
		$background_border_group = cozy_edge_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border','cozy'),
			'description'	=> esc_html__('Setup form elements background and border style','cozy'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = cozy_edge_add_admin_row(array(
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color','cozy'),
		));
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency','cozy'),
		));

		$background_border_row2 = cozy_edge_add_admin_row(array(
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency','cozy'),
		));
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color','cozy'),
		));
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency','cozy'),
		));

		$background_border_row3 = cozy_edge_add_admin_row(array(
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width','cozy'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius','cozy'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = cozy_edge_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding','cozy'),
			'description'	=> esc_html__('Setup form elements padding','cozy'),
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = cozy_edge_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top','cozy'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom','cozy'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = cozy_edge_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin','cozy'),
			'description'	=> esc_html__('Setup form elements margin','cozy'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = cozy_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Margin Top','cozy'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Margin Bottom','cozy'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height','cozy'),
			'description'	=> esc_html__('Enter height for textarea form element','cozy'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = cozy_edge_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography','cozy'),
			'description'	=> esc_html__('Setup button text typography','cozy'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = cozy_edge_add_admin_row(array(
		...
		$button_typography_row2 = cozy_edge_add_admin_row(array(
		...
		$button_background_border_group = cozy_edge_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border','cozy'),
			'description'	=> esc_html__('Setup button background and border style','cozy'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = cozy_edge_add_admin_row(array(
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency','cozy'),
		));

		$button_background_border_row2 = cozy_edge_add_admin_row(array(
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color','cozy'),
		));
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency','cozy'),
		));

		$button_background_border_row3 = cozy_edge_add_admin_row(array(
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height','cozy'),
			'description'	=> esc_html__('Insert form button height','cozy'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		cozy_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding','cozy'),
			'description'	=> esc_html__('Enter value for button left and right padding','cozy'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = cozy_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2','cozy'),
		));
		...
		$panel_contact_form_style_3 = cozy_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_3',
			'title'	=> esc_html__('Custom Style 3','cozy'),
		));
	...
	add_action( 'cozy_edge_options_map', 'cozy_edge_contact_form_7_options_map', 19);
