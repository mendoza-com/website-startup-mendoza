<?php
namespace CozyEdge\Modules\Shortcodes\Blockquote;
...
class Blockquote implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Edge Blockquote', 'cozy'),
				'base' => $this->getBase(),
				...
				'params' => array(
					array(
						...
						"param_name" => "text",
						"value" => esc_html__("Blockquote text", 'cozy'),
						"save_always" => true
					),
					array(
						"type" => "dropdown",
	...
	public function render($atts, $content = null) {
		...
		$html = cozy_edge_get_shortcode_module_template_part('templates/blockquote-template', 'blockquote', '', $params);
