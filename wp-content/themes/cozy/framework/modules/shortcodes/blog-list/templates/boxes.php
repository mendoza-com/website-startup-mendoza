<li class="edgtf-blog-list-item clearfix">
	<div class="edgtf-blog-list-item-inner">
		...
		<div class="edgtf-item-text-holder" <?php cozy_edge_inline_style($box_style); ?>>
			...
			<?php } ?>
			<a itemprop="url" href="<?php the_permalink(); ?>" class="edgtf-blog-list-read-more"><?php esc_html_e('Read more','cozy') ?><i class="lnr-arrow-right lnr"></i></a>
		</div>
	</div>	
</li>