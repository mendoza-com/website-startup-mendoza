<?php
namespace CozyEdge\Modules\Shortcodes\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface{
	...
	public function vcMap() {
		if(function_exists('vc_map')){
			vc_map( 
				array(
					'name' => esc_html__('Edge Elements Holder Item', 'cozy'),
					'base' => $this->base,
					...
					'params' => array(
						...
						array(
							'type' => 'dropdown',
							'heading' => esc_html__('Zoom Effect','cozy'),
						...
						array(
							'type' => 'textfield',
							'class' => '',
							'heading' => esc_html__('Padding','cozy'),
							'param_name' => 'item_padding',
							'value' => '',
							'description' => esc_html__('Please insert padding in format 0px 10px 0px 10px', 'cozy')
						),
						array(
							'type' => 'dropdown',
							'class' => '',
							'heading' => esc_html__('Horizontal Alignment','cozy'),
						...
						array(
							'type' => 'dropdown',
							'class' => '',
							'heading' => esc_html__('Vertical Alignment','cozy'),
							'param_name' => 'vertical_alignment',
							'value' => array(
								esc_html__('Middle', 'cozy')    => 'middle',
								esc_html__('Top', 'cozy')    	=> 'top',
								esc_html__('Bottom', 'cozy')    => 'bottom'
							),
							'description' => ''
						),
						array(
							'type' => 'dropdown',
							'class' => '',
							'heading' => esc_html__('Animation Name','cozy'),
							'param_name' => 'animation_name',
							'value' => array(
								esc_html__('No Animation', 'cozy')			=> '',
								esc_html__('Flip In', 'cozy')				=> 'flip-in',
								esc_html__('Grow In', 'cozy')				=> 'grow-in',
								esc_html__('X Rotate', 'cozy')				=> 'x-rotate',
								esc_html__('Z Rotate', 'cozy')				=> 'z-rotate',
								esc_html__('Y Translate', 'cozy')			=> 'y-translate',
								esc_html__('Fade In', 'cozy')				=> 'fade-in',
								esc_html__('Fade In Down', 'cozy')			=> 'fade-in-down',
								esc_html__('Fade In Left X Rotate', 'cozy') => 'fade-in-left-x-rotate'
							)
						),
						array(
							'type' => 'textfield',
						...
						array(
							...
							'heading' => esc_html__('Padding on screen size between 1280px-1600px','cozy'),
						...
						array(
							...
							'class' => '',
							'group' => esc_html__('Width & Responsiveness','cozy'),
							'heading' => esc_html__('Padding on screen size between 1024px-1280px','cozy'),
						...
						array(
							...
							'class' => '',
							'group' => esc_html__('Width & Responsiveness','cozy'),
							'heading' => esc_html__('Padding on screen size between 768px-1024px','cozy'),
						...
						array(
							...
							'class' => '',
							'group' => esc_html__('Width & Responsiveness','cozy'),
							'heading' => esc_html__('Padding on screen size between 600px-768px','cozy'),
						...
						array(
							...
							'class' => '',
							'group' => esc_html__('Width & Responsiveness','cozy'),
							'heading' => esc_html__('Padding on screen size between 480px-600px','cozy'),
						...
						array(
							...
							'class' => '',
							'group' => esc_html__('Width & Responsiveness','cozy'),
							'heading' => esc_html__('Padding on Screen Size Bellow 480px','cozy'),
	...
	public function render($atts, $content = null) {
		...
		$html = cozy_edge_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
