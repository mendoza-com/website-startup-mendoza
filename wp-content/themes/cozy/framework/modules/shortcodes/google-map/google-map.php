<?php
namespace CozyEdge\Modules\Shortcodes\GoogleMap;
...
class GoogleMap implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Edge Google Map', 'cozy'),
				'base' => $this->base,
				...
				'params' => array(
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 1','cozy'),
						'param_name' => 'address1',
						'admin_label' => true
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 2','cozy'),
						'param_name' => 'address2',
						'admin_label' => true,
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 3','cozy'),
						'param_name' => 'address3',
						'admin_label' => true,
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 4','cozy'),
						'param_name' => 'address4',
						'admin_label' => true,
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 5','cozy'),
						'param_name' => 'address5',
						'admin_label' => true,
					...
					array(
						'type' => 'dropdown',
						'heading' => esc_html__('Custom Map Style','cozy'),
						'param_name' => 'custom_map_style',
						'value' => array(
							esc_html__('No','cozy') => 'false',
							esc_html__('Yes','cozy') => 'true'
						),
						'save_always' => true,
						'description' => esc_html__('Enabling this option will allow Map editing', 'cozy')
					),
					array(
						'type' => 'colorpicker',
						'heading' => esc_html__('Color Overlay','cozy'),
						'param_name' => 'color_overlay',
						'description' => esc_html__('Choose a Map color overlay','cozy'),
						'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Saturation','cozy'),
						'param_name' => 'saturation',
						'description' => esc_html__('Choose a level of saturation (-100 = least saturated, 100 = most saturated)','cozy'),
						'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Lightness','cozy'),
						'param_name' => 'lightness',
						'description' => esc_html__('Choose a level of lightness (-100 = darkest, 100 = lightest)','cozy'),
						'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type' => 'attach_image',
						'heading' => esc_html__('Pin','cozy'),
						'param_name' => 'pin',
						'description' => esc_html__('Select a pin image to be used on Google Map', 'cozy')
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Map Zoom','cozy'),
						'param_name' => 'zoom',
						'description' => esc_html__('Enter a zoom factor for Google Map (0 = whole worlds, 19 = individual buildings)', 'cozy')
					),
					array(
						'type' => 'dropdown',
						'heading' => esc_html__('Zoom Map on Mouse Wheel','cozy'),
						...
						'save_always' => true,
						'description' => esc_html__('Enabling this option will allow users to zoom in on Map using mouse wheel', 'cozy')
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Map Height','cozy'),
	...
	public function render($atts, $content = null) {
		...
		$html = cozy_edge_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
