...
class PieChartPie implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Edge Pie Chart 2 (Pie)', 'cozy'),
			'base' => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$html = cozy_edge_get_shortcode_module_template_part('templates/pie-chart-pie', 'piecharts/piechartpie', '', $params);
