...
class HeaderFullScreen extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = cozy_edge_filter_px(cozy_edge_options()->getOptionValue('menu_area_height_header_full_screen'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['menu_area_in_grid'] = cozy_edge_get_meta_field_intersect('menu_area_in_grid_header_full_screen') == 'yes' ? true : false;

        $parameters = apply_filters('cozy_edge_header_full_screen_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } elseif(cozy_edge_options()->getOptionValue('menu_area_background_color_header_full_screen') == '') {
            $menuAreaTransparent = cozy_edge_options()->getOptionValue('menu_area_grid_background_color_header_full_screen') !== '' &&
                                   cozy_edge_options()->getOptionValue('menu_area_grid_background_transparency_header_full_screen') !== '1';
        } else {
            $menuAreaTransparent = cozy_edge_options()->getOptionValue('menu_area_background_color_header_full_screen') !== '' &&
                                   cozy_edge_options()->getOptionValue('menu_area_background_transparency_header_full_screen') !== '1';
        }
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'edgtf_menu_area_background_color_header_full_screen_meta', true) !== ''){
            ...
            $menuAreaTransparent = cozy_edge_options()->getOptionValue('menu_area_grid_background_color_header_full_screen') !== '' &&
                                   cozy_edge_options()->getOptionValue('menu_area_grid_background_transparency_header_full_screen') === '0';
        } else {
            $menuAreaTransparent = cozy_edge_options()->getOptionValue('menu_area_background_color_header_full_screen') !== '' &&
                                   cozy_edge_options()->getOptionValue('menu_area_background_transparency_header_full_screen') === '0';
        }
