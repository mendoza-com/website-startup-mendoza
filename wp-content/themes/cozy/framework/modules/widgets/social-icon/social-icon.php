 ...
 */
class CozyEdgeSocialIconWidget extends CozyEdgeWidget {
    /**
    ...
    protected function setParams() {
        $this->params = array_merge(
            cozy_edge_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Link','cozy'),
                    'name' => 'link',
                    'description' => ''
                ),
                array(
                    'type' => 'dropdown',
                    'title' => esc_html__('Target','cozy'),
                    'name' => 'target',
                    'options' => array(
                ...
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Text Size (px)','cozy'),
                    'name' => 'text_size',
                    'description' => ''
                ),
                array(
                ...
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Hover Color','cozy'),
                    'name' => 'hover_color',
                    'description' => ''
                ),
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Margin','cozy'),
                    'name' => 'margin',
    ...
    public function widget($args, $instance) {
        ...
        <a class="edgtf-social-icon-widget-holder" <?php echo cozy_edge_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php cozy_edge_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
