   ...
   vc.builder = {
    ...
    var VisualComposer = Backbone.View.extend({
        ...
        events:{
            ...
            "click #vc_add-page-section-button":'createPageSection',
        ...
        dropButton:function (event, ui) {
            if (ui.draggable.is('#wpb-add-new-element')) {
                ...
                this.createRow();
            } else if (ui.draggable.is('#wpb-add-new-page-section')) {
        ...
        /* MK framework addition */
        createPageSection:function () {
            var page_section = Shortcodes.create({shortcode:'mk_page_section'});
            Shortcodes.create({shortcode:'vc_column', params:{width:'1/1'}, parent_id:page_section.id, root_id:page_section.id });
            return page_section;
        },
        /**
