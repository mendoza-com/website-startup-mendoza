...
function edgt_slides_category_taxonomy_custom_fields($tag) {
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Slider shortcode', 'edge-cpt'); ?></label>
        </th>
        <td>
            ...
            <span class="description"><?php esc_html_e('Use this shortcode to insert it on page', 'edge-cpt'); ?></span>
        </td>
    </tr>
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Anchor', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Effect on header (dark/light style)', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Show prev/next thumbs (except for side menu or passepartout)', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Show navigation thumbs', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Show slide number', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Parallax effect', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Auto start', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Slides Animation', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Time between slide transitions in milliseconds', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Slider height in px', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Responsive height', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Show Navigation Arrows', 'edge-cpt'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php esc_html_e('Show Navigation Bullets', 'edge-cpt'); ?></label>
        </th>
        <td>
...
function edgt_theme_columns($theme_columns) {
    $new_columns = array(
        ...
        'name' => esc_html__('Name', 'edge-cpt'),
        'shortcode' => esc_html__('Shortcode', 'edge-cpt'),
        'slug' => esc_html__('Slug', 'edge-cpt'),
        'posts' => esc_html__('Posts', 'edge-cpt')
    );
    return $new_columns;
}
